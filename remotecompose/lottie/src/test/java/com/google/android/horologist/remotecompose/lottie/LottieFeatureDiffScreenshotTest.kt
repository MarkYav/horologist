...
class LottieFeatureDiffScreenshotTest : LottieDiffScreenshotTest() {
  ...
  /** Tests linear gradient fill with multi-progress animation (0.0, 0.25, 0.5, 0.75, 1.0). */
  @Test
  fun gradientLinearMultiProgress() {
    val json =
      """
      {
        "v": "5.7.0",
    ...
    runLottieDiffTest(json = json) {
      ...
      captureProgress(0.75f)
      captureProgress(1.0f)
    }
  }

  /** Tests radial gradient fill with multi-progress animation (0.0, 0.25, 0.5, 0.75, 1.0). */
  @Test
  fun gradientRadialMultiProgress() {
    val json =
      """
      {
        "v": "5.7.0",
  ...
  /** Tests track matte clipping with multi-progress animation (0.0, 0.25, 0.5, 0.75, 1.0). */
  @Test
  fun trackMatteMultiProgress() {
    val json =
      """
      {
        "v": "5.7.0",
        ...
        "layers": [
          {
            ...
            "ks": {
              ...
              "s": {
                "a": 1,
                "k": [
                  { "t": 0, "s": [80.0, 80.0, 100.0] },
                  { "t": 30, "s": [120.0, 120.0, 100.0] }
                ]
              },
              "r": {
                "a": 1,
  ...
  /** Tests precomposition rendering with multi-progress animation (0.0, 0.25, 0.5, 0.75, 1.0). */
  @Test
  fun precompMultiProgress() {
    val json =
      """
      {
        "v": "5.7.0",
  ...
  /** Tests trim paths with multi-progress animation (0.0, 0.25, 0.5, 0.75, 1.0). */
  @Test
  fun trimPathMultiProgress() {
    val json =
      """
      {
        "v": "5.7.0",
  ...
  /** Tests dash patterns with multi-progress animation (0.0, 0.25, 0.5, 0.75, 1.0). */
  @Test
  fun strokeDashMultiProgress() {
    val json =
      """
      {
        "v": "5.7.0",
            ...
            "shapes": [
              {
                ...
                "it": [
                  ...
                  },
                  {
                    "ty": "st",
                    "nm": "DashStroke",
                    "c": { "a": 0, "k": [0.3, 0.8, 0.4, 1.0] },
                    "o": { "a": 0, "k": 100.0 },
                    "w": { "a": 0, "k": 6.0 },
                    "lc": 2,
                    "lj": 2,
                    "d": [
                      { "n": "d", "nm": "dash", "v": { "a": 1, "k": [{ "t": 0, "s": [8.0] }, { "t": 30, "s": [16.0] }] } },
                      { "n": "g", "nm": "gap", "v": { "a": 0, "k": 6.0 } },
                      { "n": "o", "nm": "offset", "v": { "a": 1, "k": [{ "t": 0, "s": [0.0] }, { "t": 30, "s": [30.0] }] } }
                    ]
                  },
                  {
                    "ty": "tr",
  ...
  /** Tests merge paths with multi-progress animation (0.0, 0.25, 0.5, 0.75, 1.0). */
  @Test
  fun mergePathsMultiProgress() {
    val json =
      """
      {
        "v": "5.7.0",
