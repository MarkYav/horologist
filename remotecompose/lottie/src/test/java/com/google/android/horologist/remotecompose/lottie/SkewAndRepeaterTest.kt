...
class SkewAndRepeaterTest {
  ...
  fun evaluateRepeater_withNestedRemoteGroup_recursivelyTransformsChildShapes() {
    val childPath = RemoteDynamicGeometry(listOf(createPointBezier(0f, 0f)))
    val group =
      RemoteGroup(
    ...
    val repeaterTransform =
      Transform(
        ...
        positionTranslation = StaticPositionProperty(value = pt(20f, 0f)),
        ...
        endOpacity = StaticScalarProperty(value = 50f.rf),
      )
    ...
    val path0 = group0.childShapes[0].shapes[0] as RemoteDynamicGeometry
    assertThat(path0.path[0].vertices[0].xVal).isWithin(0.01f).of(0f)
    ...
    val path1 = group1.childShapes[0].shapes[0] as RemoteDynamicGeometry
    assertThat(path1.path[0].vertices[0].xVal).isWithin(0.01f).of(20f)
    ...
    val path2 = group2.childShapes[0].shapes[0] as RemoteDynamicGeometry
    assertThat(path2.path[0].vertices[0].xVal).isWithin(0.01f).of(40f)
