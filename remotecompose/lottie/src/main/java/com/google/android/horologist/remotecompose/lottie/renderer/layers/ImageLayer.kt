...
internal fun ImageLayer(
  ...
  val masksList = layer.masks.orEmpty()
  val hasMasks = masksList.any { it.mode != MaskMode.None && it.path != null }
  ...
  RemoteCanvas(modifier = RemoteModifier.fillMaxSize()) {
    ...
    if (hasMasks) {
      ...
      applyLayerMasks(masksList, animationSettings, remoteCanvas)
