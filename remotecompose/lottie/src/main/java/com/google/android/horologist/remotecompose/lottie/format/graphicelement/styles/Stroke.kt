...
internal fun LineCap.toStrokeCap(): androidx.compose.ui.graphics.StrokeCap =
  when (this) {
    LineCap.Butt -> androidx.compose.ui.graphics.StrokeCap.Butt
    LineCap.Round -> androidx.compose.ui.graphics.StrokeCap.Round
    LineCap.Square -> androidx.compose.ui.graphics.StrokeCap.Square
  }

internal fun LineJoin.toStrokeJoin(): androidx.compose.ui.graphics.StrokeJoin =
  when (this) {
    LineJoin.Miter -> androidx.compose.ui.graphics.StrokeJoin.Miter
    LineJoin.Round -> androidx.compose.ui.graphics.StrokeJoin.Round
    LineJoin.Bevel -> androidx.compose.ui.graphics.StrokeJoin.Bevel
  }
