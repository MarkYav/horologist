...
/**
 * Repeater modifier conforming to
 * [Repeater](https://lottie.github.io/lottie-spec/1.0.1/specs/shapes/#repeater).
 */
@Serializable
...
internal enum class CompositeMode(val value: Int) {
  ...
  companion object {
    fun fromValueOrNull(value: Int): CompositeMode? = entries.firstOrNull { it.value == value }
  }
}
