...
/**
 * Merge paths modifier conforming to
 * [Merge Paths](https://lottie.github.io/lottie-spec/1.0.1/specs/shapes/#merge-paths).
 */
@Serializable
...
internal enum class MergeMode(val value: Int) {
  ...
  companion object {
    fun fromValueOrNull(value: Int): MergeMode? = entries.firstOrNull { it.value == value }
  }
}
